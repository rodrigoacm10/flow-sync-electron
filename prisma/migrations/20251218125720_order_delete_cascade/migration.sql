...
INSERT INTO "new_OrderProduct" ("id", "orderId", "price", "productId", "productName", "quantity", "saved", "synced") SELECT "id", "orderId", "price", "productId", "productName", "quantity", "saved", "synced" FROM "OrderProduct";
